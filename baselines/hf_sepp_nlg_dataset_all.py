...
class SeppNLG(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN, gen_kwargs={"filepath": "data/all_train.csv"}),
            datasets.SplitGenerator(name=datasets.Split.VALIDATION, gen_kwargs={"filepath": "data/all_dev.csv"}),
            datasets.SplitGenerator(name=datasets.Split.TEST, gen_kwargs={"filepath": "data/all_dev.csv"}),
        ]
